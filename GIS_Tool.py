...
chart.savefig('output/Total Length of rivers in Irish Counties.png', transparent=True, dpi=300)
...
fig.savefig('output/Total area of inland water per county in ireland.png', dpi=300, bbox_inches='tight')
